        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (interaction.subcommand) {
                case "user":
                    ...
                    if (!userInfo) {
                        this.bot.client.users
                            .fetch(args.get("user").value)
                            .then((u) => {
                            let BOTSTATUS;
                            if (!u)
                        ...
                        embedMember.addField("Account created :", `${moment_1.default
                        ...
                        embedMember.addField("User information:", `** Permissions:** ${userInfo.permissions
                            .toArray()
                            .sort()
                ...
                case "bot":
                    ...
                    const embedBot = new discord_js_1.MessageEmbed()
                        ...
                        .addFields({ name: "Developer", value: `Smaug#6739`, inline: true }, {
                        name: "Data",
                        value: `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} MB`,
                        inline: true,
                    }, {
                        name: "Uptime",
                        value: `${Math.floor(this.bot.client.uptime / 1000 / 60).toString()} minutes`,
                        inline: true,
                    }, {
                        name: "Servers",
                        value: `${this.bot.client.guilds.cache.size.toString()}`,
                        inline: true,
                    }, {
                        name: "Channels",
                        value: `${this.bot.client.channels.cache.size.toString()}`,
                        inline: true,
                    }, {
                        name: "Users",
                        value: `${this.bot.client.guilds.cache
                            .map((g) => g.memberCount)
                            .reduce((a, b) => a + b)}`,
                        inline: true,
                ...
                case "server":
                    ...
                    embedInfoGuild.addFields({ name: "Name", value: `${guild_name}`, inline: true }, { name: "Owner", value: `${owner}`, inline: true }, { name: "Members", value: `${members}`, inline: true }, { name: "Channels", value: `${salons}`, inline: true }, { name: "Roles", value: `${roles}`, inline: true }, {
                        name: "Chanels",
                        value: `${this.bot.emojis.channel}Texte : ${channel_t}\n${this.bot.emojis.voice}Voice : ${channel_v}\n${this.bot.emojis.info}Categories : ${channel_c}`,
                        inline: true,
                    }, {
                        ...
                        name: `${this.bot.emojis.boost}Nitro(s) of server`,
                        value: `${boostMsg}`,
                        inline: true,
                    }
                ...
                case "role":
                    ...
                    const embedRole = new discord_js_1.MessageEmbed()
                        ...
                        .setTitle(`${role.name}`)
                        .addFields({ name: "Role", value: `${role}`, inline: true }, { name: "Color", value: `${role.hexColor}`, inline: true }, { name: "Position", value: `${role.position}`, inline: true }, { name: "ID", value: `${role.id}`, inline: true }, { name: "Manager :", value: `${manager}`, inline: true }, { name: "Mention :", value: `${mention}`, inline: true }, { name: "Members :", value: `${membersWithRole}`, inline: true }, { name: "Separation :", value: `${separation}`, inline: true }, {
                        name: "Created at  :",
                ...
                case "channel":
                    ...
                    const embedChannel = new discord_js_1.MessageEmbed()
                        ...
                        inline: true,
                    }, { name: "Position :", value: `${channel.position}`, inline: true }, { name: "\u200b", value: `\u200b`, inline: true }, {
                        name: "Created at  :",
                        value: `${moment_1.default
                            .utc(channel.createdTimestamp)
                            .format("DD/MM/YYYY - hh:mm")}`,
                        inline: true,
                    }, { name: "Type channel:", value: `${type}`, inline: true }, { name: "Channel NSFW :", value: `${nsfw}`, inline: true })
                        .setTimestamp()
                        .setFooter("Command module: Fun");
