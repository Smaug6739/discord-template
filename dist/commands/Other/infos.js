        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (interaction.subcommand) {
                ...
                case 'server':
                    ...
                    embedInfoGuild.addFields({ name: 'Name', value: `${guild_name}`, inline: true }, { name: 'Owner', value: `${owner}`, inline: true }, { name: 'Members', value: `${members}`, inline: true }, { name: 'Channels', value: `${salons}`, inline: true }, { name: 'Roles', value: `${roles}`, inline: true }, { name: 'Chanels', value: `${this.bot.emojis.channel}Texte : ${channel_t}\n${this.bot.emojis.voice}Voice : ${channel_v}\n${this.bot.emojis.info}Categories : ${channel_c}`, inline: true }, { name: 'Verification level', value: `${interaction.guild.verificationLevel}`, inline: true }, { name: `${this.bot.emojis.boost}Nitro(s) of server`, value: `${boostMsg}`, inline: true });
