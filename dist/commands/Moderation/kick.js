...
class default_1 extends CommandClass_1.default {
    ...
    execute(interaction, args, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interactionMember = yield this.bot.util.resolveMember(interaction.guild, interaction.user.id);
            ...
            if (interactionMember.roles.highest.comparePositionTo(user.roles.highest) <=
                0 &&
            ...
            if (user.kickable) {
                try {
                    ...
                    user.kick(reason).then(() => {
                        ...
                        if (settings.modLogs) {
                            const channel = this.bot.util.resolveChannel(interaction.guild, settings.modLogs);
                            if (channel &&
                                channel
