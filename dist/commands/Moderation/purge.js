    ...
    execute(interaction, args) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (interaction.subcommand) {
                case 'channel':
                    const textChannel = this.bot.util.resolveChannel(interaction.guild, (_a = args.get('channel')) === null || _a === void 0 ? void 0 : _a.value) || interaction.channel;
                ...
                case 'user':
                    ...
                    const user = yield this.bot.util.resolveMember(interaction.guild, args.get('user').value);
